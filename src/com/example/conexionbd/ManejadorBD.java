...
public class ManejadorBD extends SQLiteOpenHelper{
	  ...
	  public ArrayList<PuntoRecarga> consultPuntosRecarga()
	  {
		    ...
		    while (true)
		    {
		      ...
		      PuntoRecarga localDefPuntoRecargaSITP = new PuntoRecarga();
		      localDefPuntoRecargaSITP.setID(localCursor.getInt(0));
		      localDefPuntoRecargaSITP.setlocal(localCursor.getString(1));
		      localDefPuntoRecargaSITP.setDir(localCursor.getString(2));
		      localArrayList.add(localDefPuntoRecargaSITP);
		    }
		}
		...
		public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		 ...
		 public Cursor select(String paramString)
	    {
